...
//		System.out.format("\n4 fib (space optimized 80) %d => %d, time taken: %d", n, sum8, elapsed8);
//		/*long start81 = System.nanoTime();
//		int sum81 = fibWithMemo(n, new int[n+1]);
//		long elapsed81 = System.nanoTime() - start81;
//		System.out.format("\n4 fib (space optimized 81) %d => %d, time taken: %d", n, sum81, elapsed81);*/
//		
...
//		System.out.format("\n5 fib (space optimized) %d => %d, time taken: %d", n, sum10, elapsed10);
//		/*
//		long start11 = System.nanoTime();
//		int sum11 = fibWithMemo(n, new int[n+1]);
//		long elapsed11 = System.nanoTime() - start11;
//		System.out.format("\n4 fib (space optimized) %d => %d, time taken: %d", n, sum11, elapsed11);
//		*/
//		
//		long start12 = System.nanoTime();
//		int sum12 = fibWithMemo(n, new int[n+1]);
//		long elapsed12 = System.nanoTime() - start12;
//		System.out.format("\n5 fib (memoized) %d => %d, time taken: %d", n, sum12, elapsed12);
//		/*
//		long start13 = System.nanoTime();
//		int sum13 = fibWithMemo(n, new int[n+1]);
//		long elapsed13 = System.nanoTime() - start13;
//		System.out.format("\n4 fib (memoized) %d => %d, time taken: %d", n, sum13, elapsed13);
//		*/
	}
